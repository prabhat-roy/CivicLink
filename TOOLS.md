# TOOLS.md — every OSS tool registered for CivicLink

This file is the single inventory of every OSS tool wired up for CivicLink.
...
| security | [mosip](security/mosip/) | `security/mosip/` (scaffold) |
...
| domain-oss | [divoc](domain-oss/divoc/) | `domain-oss/divoc/` (deployable) |
| domain-oss | [opencrvs](domain-oss/opencrvs/) | `domain-oss/opencrvs/` (deployable) |
| domain-oss | [openg2p](domain-oss/openg2p/) | `domain-oss/openg2p/` (deployable) |
| domain-oss | [x-road](domain-oss/x-road/) | `domain-oss/x-road/` (deployable) |

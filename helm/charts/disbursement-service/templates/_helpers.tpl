{{/* Common name */}}
{{- define "disbursement-service.name" -}}
...
{{- define "disbursement-service.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
{{- include "disbursement-service.fullname" . -}}
{{- else -}}
...
app.kubernetes.io/name: {{ include "disbursement-service.name" . }}

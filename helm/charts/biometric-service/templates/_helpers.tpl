...
{{- define "biometric-service.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
{{- include "biometric-service.fullname" . -}}
{{- else -}}
...
app.kubernetes.io/name: {{ include "biometric-service.name" . }}

...
spark = SparkSession.builder.appName("civiclink-aggregate-daily").getOrCreate()
df = spark.read.format("iceberg").load("civiclink_mart.events_raw")
...
result.writeTo("civiclink_mart.fct_daily_metrics").using("iceberg").overwritePartitions()

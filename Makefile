# CivicLink â€” top-level Makefile
...
help:
	@echo "CivicLink â€” common targets"
	@echo ""
...
tools-deploy:  ## Deploy every OSS tool registered for CivicLink via ArgoCD
	kubectl apply -f gitops/argocd/applicationsets/all-tools-applicationset.yaml
	argocd appset get civiclink-tools --grpc-web

tools-status:  ## Show sync status of every registered tool
	argocd app list -l "project=civiclink-tools" --grpc-web

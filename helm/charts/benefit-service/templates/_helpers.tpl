...
{{- define "benefit-service.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
{{- include "benefit-service.fullname" . -}}
{{- else -}}
...
app.kubernetes.io/name: {{ include "benefit-service.name" . }}

...
{{- define "case-management.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
{{- include "case-management.fullname" . -}}
{{- else -}}
...
app.kubernetes.io/name: {{ include "case-management.name" . }}

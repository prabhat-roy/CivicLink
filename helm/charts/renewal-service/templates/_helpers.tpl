...
{{- define "renewal-service.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
{{- include "renewal-service.fullname" . -}}
{{- else -}}
...
app.kubernetes.io/name: {{ include "renewal-service.name" . }}
